#include "Pc2MoveBehaviour.h"
#include "Character.h"
#include "InputContainer.h"
#include "GameObjectContainer.h"

Pc2MoveBehaviour::Pc2MoveBehaviour() : MoveBehaviour() {}


Pc2MoveBehaviour::~Pc2MoveBehaviour()
{
}

void Pc2MoveBehaviour::Move(float dt)
{
	...
	// -- Get input from user
	bool up = iC->GetKeyState(SDLK_UP);
	bool left = iC->GetKeyState(SDLK_LEFT);
	bool down = iC->GetKeyState(SDLK_DOWN);
	bool right = iC->GetKeyState(SDLK_RIGHT);

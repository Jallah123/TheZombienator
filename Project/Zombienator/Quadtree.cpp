...
void Quadtree::Display(SDL_Renderer *renderer)
{
	...
	if (!isLeaf) {
		...
		std::pair<SDL_Texture*, SDL_Rect> t = TextureFactory::GenerateText(s, 12, rectangle.x + (rectangle.w / 2), rectangle.y + (rectangle.h / 2), FontEnum::CARTOON, SDL_Color{ 22,74, 38 });
